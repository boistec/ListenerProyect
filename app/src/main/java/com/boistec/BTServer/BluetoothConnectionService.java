...
/**
 * Created by boist on 02/08/2017.
 */

public class BluetoothConnectionService extends Thread {
    private static final String TAG = "BOISTEC ::";

    private static final String appName = "boistecBluetoothAPP";

    private UUID MY_UUID_INSECURE = UUID.fromString("61cd0cb7-3c1f-4b55-9782-a5d2eb5c2f00");
    ...
    //class to handler the new thread to connect the new device.
